...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(TIME_DOWN_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(NFC_REGISTER_Pin);
  HAL_GPIO_EXTI_IRQHandler(NFC_DELETE_Pin);
  HAL_GPIO_EXTI_IRQHandler(TIME_SET_Pin);
  HAL_GPIO_EXTI_IRQHandler(TIME_UP_Pin);
